...
if(nameUser == "" || last == "" || pass == "" || templeId == "" || email == ""){
	...
	alert("Please complete all required input");
		...
		var data = document.getElementById("videoCanvas").toDataURL();
		$.post("PHP/registerUpload.php", {imageData : data, nameUser: nameUser, midleName:midleName, last:last,
										  pass:pass, templeId:templeId, Nimagen: nameImg, email:email, cellphone:cellphone,
										  address1:address1,address2:address2,city:city,state:state,zip:zip,
										  homephone:homephone,workphone:workphone, webSite:webSite
										  });
